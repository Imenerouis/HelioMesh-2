...
Architecture
                 ...
                 │                           │
        ┌────────▼────────┐        ┌────────▼────────┐
        │ Current-state ML│        │ Temporal / Lead │
        │ Calibrated RF   │        │ evidence models │
        └────────┬────────┘        └────────┬────────┘
                 │                           │
                 └─────────────┬─────────────┘
                               │
             ...
             ┌─────────────────┼─────────────────┐
             │                 │                 │
      AUTO ROUTE SELECTED  PENDING REVIEW     ESCALATED
             │                 │                 │
             └─────────────────┼─────────────────┘
                               │
                    ┌──────────▼──────────┐
...
Architecture decisions, validation methodology, model artifacts, safety constraints, result interpretation, and final submission claims were reviewed by the project author. Numerical claims used in the final submission are derived from executable project artifacts rather than from Bob-generated prose.
